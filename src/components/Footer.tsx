...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-white">
      ...
      <div className="pointer-events-none absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-[#061428] via-[#061428]/40 to-transparent" />
      ...
      <div className="pointer-events-none absolute inset-0 opacity-[0.4]">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 1px 1px, rgba(255,153,51,0.25) 1px, transparent 0)",
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(45deg, rgba(255,153,51,0.5) 1px, transparent 1px), linear-gradient(-45deg, rgba(255,153,51,0.5) 1px, transparent 1px)",
