        ...
        <div className="relative mt-6 sm:mt-12 lg:mt-0 lg:flex-1">
          ...
          <div className="relative mx-auto aspect-square w-full max-w-[280px] sm:max-w-[380px] md:max-w-[420px] lg:max-w-[520px]">
            ...
            <svg className="pointer-events-none absolute inset-0 z-[5] hidden h-full w-full overflow-visible sm:block">
              ...
              <motion.line x1="18%" y1="92%" x2="38%" y2="75%" stroke="url(#lineGrad)" strokeWidth="1" strokeDasharray="4 4" initial={{ pathLength: 0, opacity: 0 }} whileInView={{ pathLength: 1, opacity: 1 }} viewport={{ once: false }} transition={{ delay: 0.8, duration: 0.8 }} />
